...
public:
    ...
    /**
     * @brief Method to check if there is a bus stop with the name passed as the argument
     * 
     * @param s An input bus stop name made by the user
     * 
     * @return int The integer representation in the graph of the bus stop of the same name 
     */
