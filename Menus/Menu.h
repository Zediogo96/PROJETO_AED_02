...
/**
 * @brief Menu for the best path in regards to the least amount of zone changes. Has options for the user to choose between giving a bus stop code or a location in latitude and longitude for the starting and ending bus stops.
 *
 * @param graph Graph of all the bus stops and bus lines
 */
